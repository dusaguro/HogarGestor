...
{
    public class AsignacionMedicoSugerencias : PageModel
    {
        ...
        public IActionResult OnPost(int id)
        {
            ...
            try
            {
                ...
                sugerencia.Descripcion = Request.Form["suge"];
                sugerencia.FechaHora = DateTime.Now;
                ...
                else
                {
                    ...
                    sugerencia = _sugerencia.UpdateSugerencia(sugerencia);
